...
//						System.out.println(s);
	...
	protected void interpolateField(double q2, double q3, float result[]) {
		...
		double bphi = b000 * g1 * g2 + b001 * g1 * f2 + b010 * f1 * g2 + b011 * f1
				* f2;
		...
		double brho = b000 * g1 * g2 + b001 * g1 * f2 + b010 * f1 * g2 + b011 * f1
				* f2;
		...
		double bz = b000 * g1 * g2 + b001 * g1 * f2 + b010 * f1 * g2 + b011 * f1
				* f2;
