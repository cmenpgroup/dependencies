...
/**
 * This class holds the grid parameters for one direction. The constructor is provided the 
 * min, max and number of points (inclusive, i.e., including the end points) and the step 
 * is computed.
 * 
 * @author David Heddle
...
//		if (index != newIndex) {
//			System.err.println("INDICES do not match. Old: " + index + "  New: " + newIndex + "   VAL: " + val);
...
//		}
	...
	public String toString() {
		return String.format("%-7s min: %7.2f   max: %7.2f   Np: %3d   delta: %8.3f", _name, _min, _max, _numPoints, _delta);
	}
