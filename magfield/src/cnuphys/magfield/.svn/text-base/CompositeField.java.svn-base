...
/**
 * A composition of multiple magnetic field maps.  The resulting magnetic field at
 * a given point is the sum of the constituent fields at that point.  
 * @author sebouhpaul
 *
 */
public class CompositeField extends ArrayList<IField> implements IField {
	 ...
	 * @param result the result is a float array holding the retrieved field in kiloGauss. The
	...
	/**
	 * Check whether the field is ready to be used.For a 
	 * composite field, all fields must be ready.
