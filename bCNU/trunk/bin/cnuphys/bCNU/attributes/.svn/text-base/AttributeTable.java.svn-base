...
public class AttributeTable extends JTable {
	 ...
	 * 
	 * @param uneditableKeys the uneditableKeys to set
	 */
	 ...
	 * 
	 * @param attributes the Attributes object to display and edit.
	 */
	 ...
	 * 
	 * @param helper the AttributeTableHelper to add.
	 */
	 ...
	 * 
	 * @param helper the AttributeTableHelper to remove.
	 */
	 ...
	 * @param value the object that needs rendering.
	 ...
	 * 
	 * @param name the name of the attribute
	 * @param value the object that needs an editor.
	 * @return the first non-null response, or null if no help provided.
	 */
