...
public class VectorSupport {
	...
	/**
	 * Get the vector cross product. The vectors must match
	 * and be 2D or 3D. A 3D vector is return. For for two 2D
	 * inputs, the result look like 
	 * 
	 * 
	 * @param v1 one vector
