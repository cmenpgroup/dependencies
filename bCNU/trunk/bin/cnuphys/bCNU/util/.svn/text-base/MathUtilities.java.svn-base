...
public class MathUtilities {
	 ...
	 */
	public static double perpendicularDistance(Point2D.Double p0, Point2D.Double p1,
			Point2D.Double wp, Point2D.Double pintersect) {
	 ...
	 * @param pintersect the intersection point of the perpendicular and the
	 *            line containing p0-p1. It may or may not actually be between
	 *            p0 and p1, as specified by the return argument.
