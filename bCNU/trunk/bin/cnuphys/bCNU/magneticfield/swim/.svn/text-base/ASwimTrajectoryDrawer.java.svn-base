...
public abstract class ASwimTrajectoryDrawer extends DrawableAdapter implements IProjector {
	...
	public void draw(Graphics g, IContainer container) {
		...
		if (SwimMenu.showReconstructedTracks()) {
			Vector<SwimTrajectory> trajectories = Swimming.getReconTrajectories();
...
//			g.drawPolyline(poly.xpoints, poly.ypoints, poly.npoints);
			...
			if ((lid != null)) {
				GraphicsUtilities.drawHighlightedPolyline(g2, poly.xpoints, poly.ypoints, poly.npoints, style.getLineColor(), getHighlightColor(lid));
			}
			else {
				g.drawPolyline(poly.xpoints, poly.ypoints, poly.npoints);
			}
