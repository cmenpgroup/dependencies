...
public class DrawableList extends Vector<IDrawable> implements IDrawable {
	...
	/**
	 * Set whether this logical layer is enabled. If a layer is not
	 * enabled, items on the layer cannot be selected.
	...
	/**
	 * Checks whether this logical layer is enabled. If a layer is not
	 * enabled, items on the layer cannot be selected.
