...
public enum AttributeType {
	...
	CONFIGFILE, CONTAINER, DATADIR, DRAGGABLE, FILLCOLOR, FONT, FOREGROUND, 
	FRACTION, HEADSUP, HEIGHT, ICONIFIABLE, LABELS, LEFT, LEFTMARGIN, LINECOLOR, LINESTYLE, 
	LINEWIDTH, MAXIMIZE, MAXIMIZABLE, NAME, 
	OPTIONMENUDEFAULTS, RESIZABLE, RIGHTMARGIN, ROTATABLE, SPLITWESTCOMPONENT, 
	STANDARDVIEWDECORATIONS, SYMBOLTYPE, SYMBOLSIZE, TEXT, TEXTCOLOR, TITLE, 
	TOOLBAR, TOOLBARBITS, TOP, TOPMARGIN, USERBITS, UUID, VIEWTYPE, VISIBLE, 
	WINDOWMENU, WORLDSYSTEM, WIDTH, XLABEL, YLABEL;
	 ...
	 * possibility.
	 * 
	 * @param attributes the object to fill with defaults for the standard
	 *            attributes.
	 */
