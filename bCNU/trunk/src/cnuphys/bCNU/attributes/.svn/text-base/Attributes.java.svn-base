...
//		super(193);
	 ...
	 * 
	 * @param properties the JAVA properties object.
	 */
	 ...
	 * 
	 * @param loadStandardDefaults if <code>true</code> the standard defaults
	 *            for the enum values in AttributeType are loaded.
	 ...
	 * 
	 * @param attributes the input array.
	 */
	 ...
	 * 
	 * @param nameObject the name object, the key is from the toString() method.
	 ...
	 * exist, it returns null. If the attribute is not really a Rectangle2D.Double,
	 * it returns null.
	 * 
	 * @param nameObject the name object, the key is from the toString() method.
	 ...
	 * 
	 * @param otherAttributes the other set of attributes.
	 */
