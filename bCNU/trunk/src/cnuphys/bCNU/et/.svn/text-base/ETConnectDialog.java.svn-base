...
public class ETConnectDialog extends SimpleDialog {
	...
	protected Component createCenterComponent() {
		_ippanel = new IpPortPanel(Environment.getInstance().getHostAddress(), EtConstants.serverPort);
	...
	/**
	 * A button was hit. The default behavior is to shutdown the
	 * dialog.
	 * 
	...
	/**
	 * Get what closed the dialog, either DialogUtilities.YES_RESPONSE
	 * or DialogUtilities.CANCEL_RESPONSE.
