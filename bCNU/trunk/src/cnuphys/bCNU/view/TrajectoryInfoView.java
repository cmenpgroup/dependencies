...
public abstract class TrajectoryInfoView extends BaseView implements IPhysicsEventListener {
 	
	protected TrajectoryTable _trajectoryTable;

	protected TrajectoryInfoView(String title) {
		super(AttributeType.TITLE, title,
				AttributeType.ICONIFIABLE, true, AttributeType.MAXIMIZABLE,
				true, AttributeType.CLOSABLE, true, AttributeType.RESIZABLE,
				true, AttributeType.WIDTH, 760, AttributeType.HEIGHT, 250,
				AttributeType.LEFT, 700,
				AttributeType.TOP, 100,
