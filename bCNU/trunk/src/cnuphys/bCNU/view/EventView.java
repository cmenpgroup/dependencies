...
//	public KeyAdapter _keyAdapter;
	...
	//				System.err.println("HEY MAN (button 2, from view not frame) source type: " + EventControl.getEventSourceType());
	...
	public static int numberOfRemainingEvents() {
		...
		try {
			...
			int evNum = (currentEvent == null) ? 0 : currentEvent.getEventNumber();
			return count - evNum;
...
//		menu.add(eventMenu.createEventMenu());
	 ...
	 * @param menu the Swing menu
	 * @param eventMenu the jevio EventMenu 
	 */
