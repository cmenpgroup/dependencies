...
public class ImageManager {
	...
	/**
	 * This constructor takes no arguments. It is the private 
	 * constructor used to make the singleton.
	 */
	 ...
	 * 
	 * @param fileName the name of the file holding the image. It will first
	 *            treat this as an absolute path. If that fails, it will try to
	 *            uses it relative to the current working directory. If that
	 *            fails, relative to the home directory. If that fails, we cave.
	 * @param component a component to use as an observer. Any component should
	 *            do.
