...
public class Styled implements IStyled {
	 ...
	 * 
	 * @param attributes the attributes object to stuff.
	 */
	@Override
	 ...
	 * 
	 * @param attributes the attribute object in question.
	 */
	@Override
	public void fromAttributes(Attributes attributes) {
		...
		_lineWidth = Math.max(0, Math.min(10, attributes
				.intValue(AttributeType.LINEWIDTH)));
	}
