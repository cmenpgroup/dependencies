...
public class SplashScreen extends Window {
	 ...
	 * @param minDuration the minimum duration in milliseconds that you 
	 * want the splash screen to be visible.
	 * @throws HeadlessException, FileNotFoundException
	 */
	public SplashScreen(String imagePath, float opacity, long minDuration, List<TransientText> transientText) throws HeadlessException, FileNotFoundException {
		super(null);
		try {
