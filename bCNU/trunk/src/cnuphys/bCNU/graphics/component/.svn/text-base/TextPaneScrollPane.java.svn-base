...
public class TextPaneScrollPane extends JScrollPane {
	...
	//red terminal
	public static SimpleAttributeSet YELLOW_TERMINAL = createStyle(Color.yellow,
			transparent, "monospaced", 11, false, true);
	...
	//green terminal
	public static SimpleAttributeSet GREEN_TERMINAL = createStyle(X11Colors.getX11Color("Light Green"),
			transparent, "monospaced", 11, false, true);
	...
	public static SimpleAttributeSet GREEN_SS_12_P = createStyle(X11Colors
			.getX11Color("Dark Green"), Color.yellow, "sansserif", 12, false,
			false);
	...
	public static SimpleAttributeSet GREEN_SS_10_P = createStyle(X11Colors
			.getX11Color("Dark Green"), Color.yellow, "sansserif", 10, false,
			false);
...
//	SwingUtilities.isEventDispatchThread()
	...
	private void baseAppend(final String text, final AttributeSet style,
		...
		textPane.setCaretPosition(Math.max(0, document.getLength() - 1));
			...
			//System.err.println("TextPaneScrollPane exception " + e.getMessage());
		}
	}
