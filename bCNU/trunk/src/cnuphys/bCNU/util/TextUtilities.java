...
public class TextUtilities {
	 ...
	 * @param stepdown the step down (e.g., if the step down is 2 and the font
	 *            size is 28, a font of size 26 is returned.
	 ...
	 * 
	 * @param font the base font
	 * @param stepup the step up (e.g., if the step up is 2 and the font size is
