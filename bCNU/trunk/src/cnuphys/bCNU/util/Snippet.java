...
public class Snippet {
	 ...
	 * @param xo the x pixel coordinate of baseline of the main string of which
	 *            this is a snippet.
	 * @param yo the y pixel coordinate of baseline of the main string of which
	 *            this is a snippet.
	...
	private static Font smaller(Font font, int del) {
		return new Font(font.getName(), font.getStyle(), Math.max(4, font
				.getSize()
				- del));
	}
