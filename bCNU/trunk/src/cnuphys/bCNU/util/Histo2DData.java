...
public class Histo2DData {
	 ...
	 *            the number of bins
	 */
	public Histo2DData(String name, double valMinX, double valMaxX, int numBinsX,
			double valMinY, double valMaxY, int numBinsY) {
		
		this(name, evenBins(valMinX, valMaxX, numBinsX), evenBins(valMinY, valMaxY, numBinsY));
	}
	...
	/**
	 * Get the number on entries in the histogram that were 
     * out of range
	 * 
