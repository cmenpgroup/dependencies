...
public class HeadsUpDisplay {
	...
	public void updateHeadsUp(List<String> feedbackStrings,
		...
		_cornerRects[UPPERLEFT].setBounds(left, top, fbw,
				fbh + 4);
		_cornerRects[UPPERRIGHT].setBounds(right, top, fbw,
				fbh + 4);
		_cornerRects[LOWERRIGHT].setBounds(right, bottom, fbw,
				fbh + 4);
		_cornerRects[LOWERLEFT].setBounds(left, bottom, fbw,
				fbh + 4);
