 ...
 * is a generic class. For ced, the ced code also has a class that listens
 * for structures (an IEvioListener) which then deals with CLAS specifics.What this class does is handle the accumulation
 * of events, and notifies listeners that new events have arrived or new
 * accumulations are ready.
 * 
 * @author heddle
 * 
 */
public class EventControl implements IEvioListener {
	...
	public enum EventSourceType {FILE, ET}
	 ...
	 * @param baseStructure the base structure being passed.
	 */
	@Override
	 ...
	 * 
	 * @param baseStructure the base structure being passed.
	 * @param structure the structure received.
	 */
	@Override
	public void gotStructure(BaseStructure baseStructure, IEvioStructure structure) {
	}
	 ...
	 * 
	 * @param listener the PhysicsEvent listener to remove.
	 */
	 ...
	 * and event arrays.
	 * 
	 * @param listener the PhysicsEvent listener to add.
	 */
	...
	/**
	 * Should be a jevio method. This tries to create an evio event from a byte array
