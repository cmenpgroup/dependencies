...
public class StructureHandler {
	 ...
	 * 
	 * @param htsize the hashtable size.
	 */
	 ...
	 * num.
	 * 
	 * @param structure the structure to store.
	 */
	 ...
	 * 
	 * @param tag the tag field from the evio header.
	 * @param num the num field from the evio header.
