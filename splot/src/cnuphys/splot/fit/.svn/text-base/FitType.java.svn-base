...
public enum FitType {
	...
	public static String getFitString(Fit curveFit) {
		...
		case LINE:
			sb.append(header("Linear Fit:")
					+ descript("y = a + b&thinsp;x"));
...
//	<FONT style="BACKGROUND-COLOR: yellow">next </FONT>
	private static String colorStr(String s, String fg, String bg) {
		String htmlstr = "<font style=\"COLOR: " +
	fg + "; " + "BACKGROUND-COLOR: " +
	bg +"\">" + s + "</font>";
		return htmlstr;
	}
