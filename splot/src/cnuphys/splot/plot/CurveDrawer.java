...
//					FitUtilities.doFit(yfit, "cnuphys.splot.fit.ErfcFit");
		...
		case GAUSSIANS:
			if (yfit.isDirty()) {
				...
				try {
	//				FitUtilities.doFit(yfit, "cnuphys.splot.fit.GaussianFit");
...
//				FitUtilities.doFit(yfit, "cnuphys.splot.fit.AltPolynomialFit");
			}
...
//					FitUtilities.doFit(yfit, "cnuphys.splot.fit.PolyAndGaussianFit");
				}
