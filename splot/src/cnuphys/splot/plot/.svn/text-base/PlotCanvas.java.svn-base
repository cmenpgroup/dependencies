...
public class PlotCanvas extends JComponent implements MouseListener,
		MouseMotionListener, IRubberbanded,
	...
	/**
	 * Clear the plot of all data. It will
	 * have a null dataset.
	 */
...
//			PrintUtilities.printComponent(this);
	...
	private void takePicture() {
		try {
			...
			if (Environment.getInstance().getPngWriter() != null) {
				...
				//Buffered image object to be written to depending on the view type
				BufferedImage bi;
	...
	/**
	 * Used so another object can tell the plot canvas
	 * to fire a propert change event
	 * @param propName
	 * @param oldValue
	 * @param newValue
	 */
	...
	/**
	 * This is called as a result of a save. The canvas needs to write itself out in xml.
