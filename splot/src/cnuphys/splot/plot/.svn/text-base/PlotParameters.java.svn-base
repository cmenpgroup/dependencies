...
public class PlotParameters implements XmlPrintStreamWritable {
	 ...
	 * @return <code>true</code> we should use x data limits rather than "nice values"
	 */
	 ...
	 * @return <code>true</code> we should use y data limits rather than "nice values"
	 */
	...
	/**
	 * The exponent where we switch to scientific notation
	 * on the x axis
	...
	/**
	 * Set the exponent where we switch to scientific notation
	 * on the x axis
	...
	/**
	 * This is called as a result of a save. The object needs to write itself out in xml.
	...
	private void writeXmlMainLabels(XmlPrintStreamWriter writer) throws XMLStreamException {
	...
	private void writeXmlIncludeZero(XmlPrintStreamWriter writer) throws XMLStreamException {
		Properties props = new Properties();
	...
	private void writeLegend(XmlPrintStreamWriter writer) throws XMLStreamException {
		Properties props = new Properties();
	...
	private void writeTickValueDisplay(XmlPrintStreamWriter writer) throws XMLStreamException {
		Properties props = new Properties();
	...
	private void writeDataLimitData(XmlPrintStreamWriter writer) throws XMLStreamException {
		Properties props = new Properties();
	...
	private void writeManualRangeData(XmlPrintStreamWriter writer) throws XMLStreamException {
		Properties props = new Properties();
