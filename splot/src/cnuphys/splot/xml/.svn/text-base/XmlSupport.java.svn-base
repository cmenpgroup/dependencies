...
public class XmlSupport {
   ...
   static {
	   xmlFilter = new FileNameExtensionFilter("*.xml, *.pxml, *.splot", "xml", "pxml", "splot");
    ...
    */
	 ...
	 */
	public static void save(PlotCanvas canvas, File xmlFile) throws FileNotFoundException {
...
//Get the plot basic data	
		...
		NodeList nodes = dom.getElementsByTagName(PlotCanvas.XmlRootElementName);
		if (nodes != null) {
			System.err.println("FOUND " + nodes.getLength() + " for: " + PlotCanvas.XmlRootElementName);
		}
	}
}
