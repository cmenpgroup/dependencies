...
/**
 * Holds the Lund ID, vertex, momentum, and the initial angles giving
...
public class GeneratedParticleRecord {
	 ...
	 */
	public GeneratedParticleRecord(int charge, 
	...
	/**
	 * The total energy in GeV. This requires that we
	 * specify what particle this is.
	...
	/**
	 * Get the kinetic energy in GeV. This requires that we
	 * specify what particle this is.
	 * @param lundid the lundid of the particle
	 * 
