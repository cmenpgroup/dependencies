...
public class SwimZRange {
	...
	/** the number of steps. Defined such that z(0) = zo
	 * and z(numStep) = zf (exactly)
	 */
	...
	/**
	 * Get the step size. This is the first stepsize smaller than the
	 * one provided in the constructor that ensures an integer number of
	 * steps takes us exactly to zf, i.e. zf = zo + numStep*stepSize
	 ...
	 * @param stepSize the approximate stepsize. It will be modified to the next smaller
	 * stepsize that requires an integer number of steps.
	 */
