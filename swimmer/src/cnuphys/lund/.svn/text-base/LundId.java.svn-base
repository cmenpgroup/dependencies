...
public class LundId implements Comparable<LundId> {
	...
	public String toString() {
		...
		return String.format("%-20s %-11s  %-7d  %-8s q = %2d 2s = %-2d", _name, _type,
				_id, massStr, _chargeX3/3, _spinX2);
	}
	...
	public JComponent getLabelForLegend() {
		...
		if (style == null) {
			...
			return getLabelForLegend(style.getFillColor(), style
					.getLineColor(), _name);
		}
	}
