...
public class LundSupport {
	...
	private void initialize() {
		...
		// 510998910
		_lundIds.add(new LundId("Lepton", "e" + SUPERMINUS, 11,
				0.00051099891, -3, 1)); // e-
		_lundIds.add(new LundId("Lepton", "e" + SUPERPLUS, -11,
				0.00051099891, 3, 1)); // e+

		_lundIds.add(new LundId("Baryon", "p", 2212, 0.93827203, 3, 1));
		_lundIds.add(new LundId("Baryon", "n", 2112, 0.93956536, 0, 1));

		_lundIds.add(new LundId("Meson", SMALL_PI
				+ SUPERZERO, 111, 0.1349766, 0, 0));
		_lundIds.add(new LundId("Meson", SMALL_PI
				+ SUPERPLUS, 211, 0.13957018, 3, 0)); // pi +
		_lundIds.add(new LundId("Meson", SMALL_PI
				+ SUPERMINUS, -211, 0.13957018, -3, 0)); // pi -
		
		
		_lundIds.add(new LundId("Lepton", "nu_e", 12, 0, 0, 1));
		_lundIds.add(new LundId("Lepton", "anti-nu_e", -12, 0, 0, 1));
		_lundIds.add(new LundId("Lepton", SMALL_MU
				+ SUPERMINUS, 13, 0.1056584, -3, 1)); // mu-
		_lundIds.add(new LundId("Lepton", SMALL_MU
				+ SUPERPLUS, -13, 0.1056584, 3, 1)); // mu+
		...
		_lundIds.add(new LundId("InterBoson", SMALL_GAMMA, 22,
				0, 0, 2));  //photon
		...
		_lundIds.add(new LundId("Meson", SMALL_RHO
				+ SUPERPLUS, 213, 0.7685, 3, 2));
		_lundIds.add(new LundId("Meson", SMALL_RHO
				+ SUPERMINUS, -213, 0.7685, -3, 2));
...
//		_lundIds.add(new LundId("Meson", "K_L0", 130, 0.497614, 0, 0));
		_lundIds.add(new LundId("Meson", "K" + SUPERPLUS, 321,
				0.493677, 3, 0));
		_lundIds.add(new LundId("Meson", "K" + SUPERMINUS, -321,
				0.493677, -3, 0));
...
//		_lundIds.add(new LundId("Meson", "anti-D*(2S)0", -30423, 2.64, 0, 2));
...
//		_lundIds.add(new LundId("Meson", "eta_c(2S)", 20441, 3.637, 0, 0));
	...
	//	_lundIds.add(new LundId("Baryon", "anti-Delta+", -1114, 1.234, 3, 3));
	//	_lundIds.add(new LundId("Baryon", "anti-n0", -2112, 0.93956536, 0, 1));
	//	_lundIds.add(new LundId("Baryon", "Delta0", 2114, 1.233, 0, 3));
	//	_lundIds.add(new LundId("Baryon", "anti-Delta0", -2114, 1.233, 0, 3));
		_lundIds.add(new LundId("Baryon", "anti-p", -2212, 0.93827203, -3, 1));
		_lundIds.add(new LundId("Baryon", "Delta+", 2214, 1.232, 3, 3));
	//	_lundIds.add(new LundId("Baryon", "anti-Delta-", -2214, 1.232, -3, 3));
		_lundIds.add(new LundId("Baryon", "Delta++", 2224, 1.231, 6, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Delta--", -2224, 1.231, -6, 3));
		_lundIds.add(new LundId("Baryon", BIG_LAMBDA+SUBZERO, 3122, 1.115683, 0, 1));
//		_lundIds
//				.add(new LundId("Baryon", "anti-Lambda0", -3122, 1.115683, 0, 1));
//		_lundIds.add(new LundId("Baryon", "Lambda(1405)0", 13122, 1.406, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda(1405)0", -13122, 1.406,
//				0, 1));
//		_lundIds.add(new LundId("Baryon", "Lambda(1520)0", 3124, 1.5195, 0, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda(1520)0", -3124, 1.5195,
//				0, 3));
//		_lundIds.add(new LundId("Baryon", "Lambda(1600)0", 23122, 1.6, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda(1600)0", -23122, 1.6, 0,
//				1));
//		_lundIds.add(new LundId("Baryon", "Lambda(1670)0", 33122, 1.67, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda(1670)0", -33122, 1.67,
//				0, 1));
//		_lundIds.add(new LundId("Baryon", "Lambda(1690)0", 13124, 1.69, 0, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda(1690)0", -13124, 1.69,
//				0, 3));
//		_lundIds.add(new LundId("Baryon", "Lambda(1800)0", 43122, 1.8, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda(1800)0", -43122, 1.8, 0,
//				1));
//		_lundIds.add(new LundId("Baryon", "Lambda(1810)0", 53122, 1.81, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda(1810)0", -53122, 1.81,
//				0, 1));
//		_lundIds.add(new LundId("Baryon", "Lambda(1820)0", 3126, 1.82, 0, 5));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda(1820)0", -3126, 1.82, 0,
//				5));
//		_lundIds.add(new LundId("Baryon", "Lambda(1830)0", 13126, 1.83, 0, 5));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda(1830)0", -13126, 1.83,
//				0, 5));
//		_lundIds.add(new LundId("Baryon", "Sigma(1660)0", 13212, 1.66, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Sigma(1660)0", -13212, 1.66, 0,
//				1));
//		_lundIds.add(new LundId("Baryon", "Sigma(1670)0", 13214, 1.67, 0, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Sigma(1670)0", -13214, 1.67, 0,
//				3));
//		_lundIds.add(new LundId("Baryon", "Sigma(1750)0", 23212, 1.75, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Sigma(1750)0", -23212, 1.75, 0,
//				1));
//		_lundIds.add(new LundId("Baryon", "Sigma(1775)0", 3216, 1.775, 0, 5));
//		_lundIds.add(new LundId("Baryon", "anti-Sigma(1775)0", -3216, 1.775, 0,
//				5));
...
//		_lundIds.add(new LundId("Baryon", "anti-Sigma*+", -3114, 1.3872, 3, 3));
...
//		_lundIds.add(new LundId("Baryon", "anti-Sigma*0", -3214, 1.3837, 0, 3));
...
//		_lundIds.add(new LundId("Baryon", "anti-Omega+", -3334, 1.67245, 3, 3));
//		_lundIds.add(new LundId("Baryon", "Lambda_c+", 4122, 2.28646, 3, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda_c-", -4122, 2.28646, -3,
//				1));
//		_lundIds.add(new LundId("Baryon", "Lambda_c(2593)+", 14122, 2.5954, 3,
//				1));
//		_lundIds.add(new LundId("Baryon", "anti-Lambda_c(2593)-", -14122,
//				2.5954, -3, 1));
//		_lundIds.add(new LundId("Baryon", "Lambda_c(2625)+", 14124, 2.6281, 3,
//				3));
...
//		_lundIds.add(new LundId("Baryon", "anti-Sigma_c--", -4222, 2.45402, -6,
//				1));
...
//		_lundIds.add(new LundId("Baryon", "anti-Sigma_c*-", -4214, 2.5175, -3,
//				3));
//		_lundIds.add(new LundId("Baryon", "Sigma_c*++", 4224, 2.5184, 6, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Sigma_c*--", -4224, 2.5184, -6,
//				3));
//		_lundIds.add(new LundId("Baryon", "Xi_c0", 4132, 2.4710, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Xi_c0", -4132, 2.4710, 0, 1));
//		_lundIds.add(new LundId("Baryon", "Xi_c+", 4232, 2.4679, 3, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Xi_c-", -4232, 2.4679, -3, 1));
//		_lundIds.add(new LundId("Baryon", "Xi'_c0", 4312, 2.5780, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Xi'_c0", -4312, 2.5780, 0, 1));
//		_lundIds.add(new LundId("Baryon", "Xi'_c+", 4322, 2.5757, 3, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Xi'_c-", -4322, 2.5757, -3, 1));
//		_lundIds.add(new LundId("Baryon", "Xi_c*0", 4314, 2.6461, 0, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Xi_c*0", -4314, 2.6461, 0, 3));
//		_lundIds.add(new LundId("Baryon", "Xi_c*+", 4324, 2.6466, 3, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Xi_c*-", -4324, 2.6466, -3, 3));
...
//		_lundIds.add(new LundId("Baryon", "anti-Omega_c*0", -4334, 2.8, 0, 3));
...
//		_lundIds.add(new LundId("Baryon", "anti-Xi_cc*--", -4424, 3.65648, -6,
//				3));
//		_lundIds.add(new LundId("Baryon", "Omega_cc+", 4432, 3.78663, 3, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Omega_cc-", -4432, 3.78663, -3,
//				1));
//		_lundIds.add(new LundId("Baryon", "Omega_cc*+", 4434, 3.82466, 3, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Omega_cc*-", -4434, 3.82466,
//				-3, 3));
//		_lundIds.add(new LundId("Baryon", "Omega_ccc*++", 4444, 4.91594, 6, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Omega_ccc*--", -4444, 4.91594,
//				-6, 3));
...
//		_lundIds.add(new LundId("Baryon", "anti-Xi_b+", -5132, 5.7924, 3, 1));
//		_lundIds.add(new LundId("Baryon", "Sigma_b0", 5212, 5.81, 0, 1));
//		_lundIds.add(new LundId("Baryon", "anti-Sigma_b0", -5212, 5.81, 0, 1));
//		_lundIds.add(new LundId("Baryon", "Sigma_b*0", 5214, 5.83, 0, 3));
//		_lundIds.add(new LundId("Baryon", "anti-Sigma_b*0", -5214, 5.83, 0, 3));
...
//		_lundIds.add(new LundId("Baryon", "anti-Sigma_b*-", -5224, 5.8290, -3,
//				3));
	...
	public static int geantToLund(int geantId) {
		...
		default:
			System.err.println(
					"Unrecognized Geant particle ID: " + geantId);
			return -1;
		}
	}
