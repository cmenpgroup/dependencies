...
public class LundStyle {
	...
	private static BasicStroke _solid = new BasicStroke(_LINEWIDTH, BasicStroke.CAP_ROUND,
			BasicStroke.JOIN_ROUND);
	
	private static BasicStroke _dashed = new BasicStroke(_LINEWIDTH, BasicStroke.CAP_BUTT,
	...
	/**
	 * Get a style for a given lund Id. Returns _unknownStyle if
	 * the style hasn't been added yet or lundId is null.
