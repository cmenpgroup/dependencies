...
public class SwimTrajectory2D {
	...
	public void addToFeedback(List<String> feedbackStrings) {
		...
		String s2 = fbColor
				+ String.format("Vtx (%-3.1f, %-3.1f, %-3.1f) cm %-1s: %-6.2f  %-1s: %-6.2f",
	...
	public String summaryString() {
		...
		sb.append(String.format(" P %-4.1f GeV/c",
				genPart.getMomentum()));
		...
		sb.append(String.format("  %-1s %-6.2f  %-1s %-6.2f",
				SMALL_THETA, genPart.getTheta(),
				SMALL_PHI, genPart.getPhi()));
	 ...
	 * @param pintersect the intersection point of the perpendicular and the
	 *            line containing p0-p1. It may or may not actually be between
	 *            p0 and p1, as specified by the value of t.
	 ...
	 */
	public static double perpendicularDistance(Point.Double p0, Point.Double p1,
			Point.Double wp, Point.Double pintersect) {
