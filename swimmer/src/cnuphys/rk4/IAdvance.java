...
public interface IAdvance {
	 ...
	 * @param dydt values of the derivative at the current t (before advance) (input).
	 * @param h the current step size (input)
	 * @param deriv the function (interface) that can compute the derivatives.
	 ...
	 * @param error the error vector which is filled in if the advancer knows how to compute errors
	 */
