...
public class ButcherTableau {
	...
	public static ButcherTableau RK4 = new ButcherTableau("RK4", false,
			...
			makeRow(1./2., 0, 1./2),
			makeRow(1., 0, 0, 1.),
			makeRow(1./6., 1./3., 1./3., 1./6.) // the b's
			);
	...
	public static ButcherTableau RULE38 = new ButcherTableau("RULE38", false,
			...
			makeRow(2./3., -1./3., 1.),
			makeRow(1., 1., -1., 1.),
			makeRow(1./8., 3./8., 3./8., 1./8.) // the b's
			);

	public static ButcherTableau FEHLBERG_ORDER5 = new ButcherTableau("FEHLBERG_ORDER5", true,
			makeRow(0.),
			makeRow(1./4., 1./4.),
			makeRow(3./8., 3./32., 9./32.),
	...
	public static ButcherTableau DORMAND_PRINCE = new ButcherTableau("DORMAND_PRINCE", true,
			makeRow(0.),
			makeRow(1./5., 1./5.),
	...
	public static ButcherTableau CASH_KARP = new ButcherTableau("CASH_KARP", true,
			makeRow(0.),
			makeRow(1./5., 1./5.),
			makeRow(3./10., 3./40., 9./40.),
	...
	private void printSumStr(int index) {
		...
		double c = c(index);
		System.out.println("sum check [" + index + "] sum: " + sum + "  c: " + c);
	}
	public void report() {
		System.out.println("=============");
